...
<head>
    ...
    <nav class="white z-depth-3">
        ...
        <ul class="right hide-on-med-and-down">
            ...
            <li><a href="<?php echo site_url('/cart') ?>" class="grey-text text-darken-2">Cart <?php echo count($this->cart->contents())?><i class="material-icons right">arrow_drop_down</i></a></li>
